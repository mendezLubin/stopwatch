...
*/
let centisecondsUntilButtonWasPressed= null; // To save the time elapsed between when the page loaded and when the play button was pressed
...
function funcReset() {
  ...
  accumulatedElapsed = 0; // Reset to cero
